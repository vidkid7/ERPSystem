...
interface SixthCallLogRow {
  id: number;
  description: string;
  amount: number;
}

const SixthCallLogPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<SixthCallLogRow[]>([]);

  const columns: ColumnsType<SixthCallLogRow> = [
...
export default SixthCallLogPage;
