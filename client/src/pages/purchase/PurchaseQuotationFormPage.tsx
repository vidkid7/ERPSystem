...
const PurchaseQuotationFormPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await api.post('/purchase/quotation', payload);
      message.success('Purchase quotation created');
  ...
  return (
    <FormPage title="New Purchase Quotation" loading={loading} onSubmit={handleSubmit} backPath="/purchase/quotations">
