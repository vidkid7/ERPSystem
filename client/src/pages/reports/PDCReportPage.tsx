...
const PDCReportPage: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Cheque Date', dataIndex: 'chequeDate', key: 'chequeDate' },
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await api.get('/reporting/pdc');
  ...
  return (
    <Card title="Post Dated Cheque Report">
