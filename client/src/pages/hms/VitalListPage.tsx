...
const VitalListPage: React.FC = () => {
  ...
  const fetchData = async (p = page, s = search) => {
    setLoading(true);
    try {
      const res = await api.get('/vital', { params: { search: s, page: p, pageSize: 20 } });
  ...
  return (
    <ListPage<Vital>
      title="Vitals" columns={columns} dataSource={data} loading={loading}
