...
interface PendingCannibalizeInPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const PendingCannibalizeInPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<PendingCannibalizeInPageRow[]>([]);

  const columns: ColumnsType<PendingCannibalizeInPageRow> = [
  ...
  return (
    <Card title="Pending Cannibalize In">
...
export default PendingCannibalizeInPage;
