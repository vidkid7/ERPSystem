...
interface CostCenterAgeingPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const CostCenterAgeingPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<CostCenterAgeingPageRow[]>([]);

  const columns: ColumnsType<CostCenterAgeingPageRow> = [
...
export default CostCenterAgeingPage;
