...
interface PendingStockReceivedPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const PendingStockReceivedPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<PendingStockReceivedPageRow[]>([]);

  const columns: ColumnsType<PendingStockReceivedPageRow> = [
  ...
  return (
    <Card title="Pending Stock Received">
...
export default PendingStockReceivedPage;
