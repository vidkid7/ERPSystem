...
interface OutStockBillWisePageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const OutStockBillWisePage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<OutStockBillWisePageRow[]>([]);

  const columns: ColumnsType<OutStockBillWisePageRow> = [
  ...
  return (
    <Card title="Out Stock Bill Wise">
...
export default OutStockBillWisePage;
