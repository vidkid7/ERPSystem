...
interface AllAgentSalesSummaryPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const AllAgentSalesSummaryPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<AllAgentSalesSummaryPageRow[]>([]);

  const columns: ColumnsType<AllAgentSalesSummaryPageRow> = [
  ...
  return (
    <Card title="All Agent Sales Summary">
...
export default AllAgentSalesSummaryPage;
