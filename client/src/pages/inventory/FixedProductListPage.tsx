...
interface FixedProductListPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const FixedProductListPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<FixedProductListPageRow[]>([]);

  const columns: ColumnsType<FixedProductListPageRow> = [
...
export default FixedProductListPage;
