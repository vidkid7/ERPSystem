...
interface CRLimitExpiredPartyPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const CRLimitExpiredPartyPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<CRLimitExpiredPartyPageRow[]>([]);

  const columns: ColumnsType<CRLimitExpiredPartyPageRow> = [
  ...
  return (
    <Card title="CR Limit Expired Party">
...
export default CRLimitExpiredPartyPage;
