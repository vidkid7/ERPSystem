...
interface ProductGroupReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductGroupReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductGroupReportPageRow[]>([]);

  const columns: ColumnsType<ProductGroupReportPageRow> = [
  ...
  return (
    <Card title="Product Group Report">
