...
interface ProductRackListPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductRackListPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductRackListPageRow[]>([]);

  const columns: ColumnsType<ProductRackListPageRow> = [
...
export default ProductRackListPage;
