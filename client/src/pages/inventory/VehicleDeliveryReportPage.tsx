...
const VehicleDeliveryReportPage: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/vehicle-delivery', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
...
export default VehicleDeliveryReportPage;
