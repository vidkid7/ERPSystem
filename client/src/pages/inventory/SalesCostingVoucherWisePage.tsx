...
interface SalesCostingVoucherWisePageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const SalesCostingVoucherWisePage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<SalesCostingVoucherWisePageRow[]>([]);

  const columns: ColumnsType<SalesCostingVoucherWisePageRow> = [
  ...
  return (
    <Card title="Sales Costing Voucher Wise">
...
export default SalesCostingVoucherWisePage;
