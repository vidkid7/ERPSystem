...
interface ProductionOrderReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductionOrderReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductionOrderReportPageRow[]>([]);

  const columns: ColumnsType<ProductionOrderReportPageRow> = [
  ...
  return (
    <Card title="Production Order Report">
...
export default ProductionOrderReportPage;
