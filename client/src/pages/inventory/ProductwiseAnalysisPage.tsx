...
interface ProductwiseAnalysisPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductwiseAnalysisPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductwiseAnalysisPageRow[]>([]);

  const columns: ColumnsType<ProductwiseAnalysisPageRow> = [
  ...
  return (
    <Card title="Product Wise Analysis">
...
export default ProductwiseAnalysisPage;
