...
interface FixedProductReportProductWisePageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const FixedProductReportProductWisePage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<FixedProductReportProductWisePageRow[]>([]);

  const columns: ColumnsType<FixedProductReportProductWisePageRow> = [
  ...
  return (
    <Card title="Fixed Product Report Product Wise">
...
export default FixedProductReportProductWisePage;
