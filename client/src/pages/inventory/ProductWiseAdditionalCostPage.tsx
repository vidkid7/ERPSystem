...
interface ProductWiseAdditionalCostPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductWiseAdditionalCostPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductWiseAdditionalCostPageRow[]>([]);

  const columns: ColumnsType<ProductWiseAdditionalCostPageRow> = [
  ...
  return (
    <Card title="Product Wise Additional Cost">
...
export default ProductWiseAdditionalCostPage;
