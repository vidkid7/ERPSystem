...
interface ProductCompanyReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductCompanyReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductCompanyReportPageRow[]>([]);

  const columns: ColumnsType<ProductCompanyReportPageRow> = [
  ...
  return (
    <Card title="Product Company Report">
...
export default ProductCompanyReportPage;
