...
interface PendingPartsDemandPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const PendingPartsDemandPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<PendingPartsDemandPageRow[]>([]);

  const columns: ColumnsType<PendingPartsDemandPageRow> = [
  ...
  return (
    <Card title="Pending Parts Demand">
...
export default PendingPartsDemandPage;
