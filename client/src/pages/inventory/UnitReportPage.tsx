...
const UnitReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<UnitReportPageRow[]>([]);

  const columns: ColumnsType<UnitReportPageRow> = [
