...
const PendingSalesQuotationPage: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/pending-sales-quotations', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
...
export default PendingSalesQuotationPage;
