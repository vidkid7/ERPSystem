...
const PurchaseAnalysisProductWisePage: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/purchase-analysis-product', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
  ...
  return (
    <Card
      title="Purchase Analysis Product Wise"
...
export default PurchaseAnalysisProductWisePage;
