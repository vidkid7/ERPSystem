...
interface ProductRateListPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductRateListPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductRateListPageRow[]>([]);

  const columns: ColumnsType<ProductRateListPageRow> = [
...
export default ProductRateListPage;
