...
interface SalesMaterializedViewPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const SalesMaterializedViewPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<SalesMaterializedViewPageRow[]>([]);

  const columns: ColumnsType<SalesMaterializedViewPageRow> = [
  ...
  return (
    <Card title="Sales Materialized View">
...
export default SalesMaterializedViewPage;
