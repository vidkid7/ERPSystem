...
const SalesTaxSummaryPage: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Tax Rate', dataIndex: 'taxRate', key: 'taxRate', align: 'right' as const },
    { title: 'Tax Amount', dataIndex: 'taxAmount', key: 'taxAmount', align: 'right' as const },
  ...
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/sales-tax-summary', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
...
export default SalesTaxSummaryPage;
