...
interface ProductOpeningReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductOpeningReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductOpeningReportPageRow[]>([]);

  const columns: ColumnsType<ProductOpeningReportPageRow> = [
  ...
  return (
    <Card title="Product Opening Report">
...
export default ProductOpeningReportPage;
