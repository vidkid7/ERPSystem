...
interface ProductCurrentStatusPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductCurrentStatusPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductCurrentStatusPageRow[]>([]);

  const columns: ColumnsType<ProductCurrentStatusPageRow> = [
  ...
  return (
    <Card title="Product Current Status">
...
export default ProductCurrentStatusPage;
