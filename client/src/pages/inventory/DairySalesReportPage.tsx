...
interface DairySalesReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const DairySalesReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<DairySalesReportPageRow[]>([]);

  const columns: ColumnsType<DairySalesReportPageRow> = [
...
export default DairySalesReportPage;
