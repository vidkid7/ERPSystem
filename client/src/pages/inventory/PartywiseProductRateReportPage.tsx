...
interface PartywiseProductRateReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const PartywiseProductRateReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<PartywiseProductRateReportPageRow[]>([]);

  const columns: ColumnsType<PartywiseProductRateReportPageRow> = [
  ...
  return (
    <Card title="Party Wise Product Rate">
...
export default PartywiseProductRateReportPage;
