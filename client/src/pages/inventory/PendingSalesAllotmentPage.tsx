...
interface PendingSalesAllotmentPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const PendingSalesAllotmentPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<PendingSalesAllotmentPageRow[]>([]);

  const columns: ColumnsType<PendingSalesAllotmentPageRow> = [
  ...
  return (
    <Card title="Pending Sales Allotment">
...
export default PendingSalesAllotmentPage;
