...
const ProductWisePartyReportPage: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/product-wise-party', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
  ...
  return (
    <Card
      title="Product Wise Party Report"
...
export default ProductWisePartyReportPage;
