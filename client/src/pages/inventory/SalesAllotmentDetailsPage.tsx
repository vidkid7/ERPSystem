...
interface SalesAllotmentDetailsPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const SalesAllotmentDetailsPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<SalesAllotmentDetailsPageRow[]>([]);

  const columns: ColumnsType<SalesAllotmentDetailsPageRow> = [
  ...
  return (
    <Card title="Sales Allotment Details">
...
export default SalesAllotmentDetailsPage;
