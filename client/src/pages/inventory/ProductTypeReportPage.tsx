...
interface ProductTypeReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductTypeReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductTypeReportPageRow[]>([]);

  const columns: ColumnsType<ProductTypeReportPageRow> = [
  ...
  return (
    <Card title="Product Type Report">
...
export default ProductTypeReportPage;
