...
interface FixedProductSellingRateReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const FixedProductSellingRateReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<FixedProductSellingRateReportPageRow[]>([]);

  const columns: ColumnsType<FixedProductSellingRateReportPageRow> = [
  ...
  return (
    <Card title="Fixed Product Selling Rate">
...
export default FixedProductSellingRateReportPage;
