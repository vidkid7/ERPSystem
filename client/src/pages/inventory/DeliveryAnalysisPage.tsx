...
const DeliveryAnalysisPage: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Delivered', dataIndex: 'delivered', key: 'delivered', align: 'right' as const },
    { title: 'Pending', dataIndex: 'pending', key: 'pending', align: 'right' as const },
  ...
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/delivery-analysis', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
