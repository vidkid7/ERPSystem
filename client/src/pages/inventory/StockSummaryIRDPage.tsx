...
interface StockSummaryIRDPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const StockSummaryIRDPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<StockSummaryIRDPageRow[]>([]);

  const columns: ColumnsType<StockSummaryIRDPageRow> = [
...
export default StockSummaryIRDPage;
