...
const BrandWiseSalesPage: React.FC = () => {
  ...
  const columns = [
    ...
    { title: 'Return', dataIndex: 'returnAmt', key: 'returnAmt', align: 'right' as const },
  ];
  const handleSearch = async () => {
    ...
    try {
      const params = dates
        ...
        : {};
      const r = await api.get('/inventory/brand-wise-sales', { params });
      setData(r.data?.Data || []);
    } catch (e) { setData([]); }
...
export default BrandWiseSalesPage;
