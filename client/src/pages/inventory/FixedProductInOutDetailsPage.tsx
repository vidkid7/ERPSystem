...
interface FixedProductInOutDetailsPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const FixedProductInOutDetailsPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<FixedProductInOutDetailsPageRow[]>([]);

  const columns: ColumnsType<FixedProductInOutDetailsPageRow> = [
  ...
  return (
    <Card title="Fixed Product In/Out Details">
...
export default FixedProductInOutDetailsPage;
