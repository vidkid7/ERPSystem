...
interface ProductSchemeReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductSchemeReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductSchemeReportPageRow[]>([]);

  const columns: ColumnsType<ProductSchemeReportPageRow> = [
  ...
  return (
    <Card title="Product Scheme Report">
...
export default ProductSchemeReportPage;
