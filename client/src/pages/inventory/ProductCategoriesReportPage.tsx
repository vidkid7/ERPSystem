...
interface ProductCategoriesReportPageRow {
  id: number;
  description: string;
  quantity: number;
  amount: number;
...
const ProductCategoriesReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProductCategoriesReportPageRow[]>([]);

  const columns: ColumnsType<ProductCategoriesReportPageRow> = [
  ...
  return (
    <Card title="Product Categories Report">
...
export default ProductCategoriesReportPage;
