...
const SalesOrderFormPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const payload = {
        ...
        salesQuotationRef: values.salesQuotationRef,
  ...
  return (
    <FormPage title="New Sales Order" loading={loading} onSubmit={handleSubmit} backPath="/sales/orders">
      <Form form={form} layout="vertical">
        <Space style={{ display: 'flex', flexWrap: 'wrap' }} size="large">
          ...
          <Form.Item name="salesQuotationRef" label="Quotation Ref">
