...
interface SalesmanReportRow {
  id: number;
  description: string;
  amount: number;
}

const SalesmanReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<SalesmanReportRow[]>([]);

  const columns: ColumnsType<SalesmanReportRow> = [
...
export default SalesmanReportPage;
