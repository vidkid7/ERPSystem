...
interface ProfitAndLossAsTRow {
  id: number;
  description: string;
  amount: number;
}

const ProfitAndLossAsTPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<ProfitAndLossAsTRow[]>([]);

  const columns: ColumnsType<ProfitAndLossAsTRow> = [
  ...
  return (
    <Card title="Profit & Loss (As Template)">
...
export default ProfitAndLossAsTPage;
