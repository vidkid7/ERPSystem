...
interface LedgerVoucherReportRow {
  id: number;
  description: string;
  amount: number;
}

const LedgerVoucherReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<LedgerVoucherReportRow[]>([]);

  const columns: ColumnsType<LedgerVoucherReportRow> = [
  ...
  return (
    <Card title="Ledger Voucher Report">
...
export default LedgerVoucherReportPage;
