...
interface NarrationMasterReportRow {
  id: number;
  description: string;
  amount: number;
}

const NarrationMasterReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<NarrationMasterReportRow[]>([]);

  const columns: ColumnsType<NarrationMasterReportRow> = [
  ...
  return (
    <Card title="Narration Master Report">
...
export default NarrationMasterReportPage;
