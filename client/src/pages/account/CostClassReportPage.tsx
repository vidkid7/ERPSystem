...
interface CostClassReportRow {
  id: number;
  description: string;
  amount: number;
}

const CostClassReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<CostClassReportRow[]>([]);

  const columns: ColumnsType<CostClassReportRow> = [
...
export default CostClassReportPage;
