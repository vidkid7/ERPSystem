...
interface StatisticVoucherDailyRow {
  id: number;
  description: string;
  amount: number;
}

const StatisticVoucherDailyPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<StatisticVoucherDailyRow[]>([]);

  const columns: ColumnsType<StatisticVoucherDailyRow> = [
  ...
  return (
    <Card title="Statistic Voucher Daily">
...
export default StatisticVoucherDailyPage;
