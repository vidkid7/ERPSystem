...
interface CurrencyReportRow {
  id: number;
  description: string;
  amount: number;
}

const CurrencyReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<CurrencyReportRow[]>([]);

  const columns: ColumnsType<CurrencyReportRow> = [
...
export default CurrencyReportPage;
