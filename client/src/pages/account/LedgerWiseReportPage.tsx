...
interface LedgerWiseReportRow {
  id: number;
  description: string;
  amount: number;
}

const LedgerWiseReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<LedgerWiseReportRow[]>([]);

  const columns: ColumnsType<LedgerWiseReportRow> = [
...
export default LedgerWiseReportPage;
