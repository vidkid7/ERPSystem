...
interface LedgerCurrentStatusRow {
  id: number;
  description: string;
  amount: number;
}

const LedgerCurrentStatusPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<LedgerCurrentStatusRow[]>([]);

  const columns: ColumnsType<LedgerCurrentStatusRow> = [
  ...
  return (
    <Card title="Ledger Current Status">
...
export default LedgerCurrentStatusPage;
