...
interface CurrencyRateReportRow {
  id: number;
  description: string;
  amount: number;
}

const CurrencyRateReportPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<CurrencyRateReportRow[]>([]);

  const columns: ColumnsType<CurrencyRateReportRow> = [
  ...
  return (
    <Card title="Currency Rate Report">
...
export default CurrencyRateReportPage;
