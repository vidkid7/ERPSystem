...
interface StatisticVoucherRow {
  id: number;
  description: string;
  amount: number;
}

const StatisticVoucherPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<StatisticVoucherRow[]>([]);

  const columns: ColumnsType<StatisticVoucherRow> = [
...
export default StatisticVoucherPage;
