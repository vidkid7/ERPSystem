...
interface VendorWiseAssetRow {
  id: number;
  description: string;
  amount: number;
}

const VendorWiseAssetPage: React.FC = () => {
  const [loading, setLoading] = useState(false);
  const [data, setData] = useState<VendorWiseAssetRow[]>([]);

  const columns: ColumnsType<VendorWiseAssetRow> = [
...
export default VendorWiseAssetPage;
